...
class ImportReconciliationNotesEvent implements ShouldBroadcast
{
    ...
    {          
        return new Channel('importreconciliation-notes-channel');
    }

    // Optionally define the event name
    public function broadcastAs()
    {      
        return 'ImportReconciliationNotesEvent';
    }
