...
class Helpers
{
  public static function appClasses()
  {
    ...
    // Menu Show/Hide
    if ($layoutClasses['menuShow'] == true) {
      $layoutClasses['menuShow'] = 'true';
    } else {
      $layoutClasses['menuShow'] = 'false';
    }

    // Footer Show/Hide
    if ($layoutClasses['footerShow'] == true) {
      $layoutClasses['footerShow'] = 'true';
    } else {
      $layoutClasses['footerShow'] = 'false';
    }
