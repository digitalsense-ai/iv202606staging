...
class ImportVatFile extends Mailable
{
    ...
    public function envelope()
    {
        ...
        //$subject_line = __('Import Vat Files', [], $email_lang);      
        $subject_line = __('Customs declaration', [], $email_lang);      
        return new Envelope(
    ...
    public function content()
    {
        ...
        return new Content(
            markdown: 'emails.'.$email_lang.'importvatfile',
            with: ['data' => $this->data],
        );
    }
