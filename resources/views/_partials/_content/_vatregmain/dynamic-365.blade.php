<div class="erp-fields mb-3" id="dynamics_365">
  <h5>Dynamics 365 API Details</h5>
  ...
  {{-- //DON'T DELETE
  <div class="form-floating mb-3" style="display: none;">
    <input type="text" class="form-control" id="api_base_url" name="api_base_url" placeholder="Base Url" value="{{ (isset($api_connection) ? $api_connection->api_base_url : 'https://api.businesscentral.dynamics.com') }}" />
    <label for="api_base_url">Base Url</label>          
  </div>
  --}} 

  <div class="form-floating mb-3">
    <input type="text" class="form-control" id="api_tenant_id" name="api_tenant_id" placeholder="Tenant Id" value="{{ (isset($api_connection) ? $api_connection->api_tenant_id : '') }}" required />
    <label for="api_tenant_id">Tenant Id</label>          
  </div>

  <div class="form-floating mb-3">
    <input type="text" class="form-control" id="api_client_id" name="api_client_id" placeholder="Client Id" value="{{ (isset($api_connection) ? $api_connection->api_client_id : '') }}" required />
    <label for="api_client_id">Client Id</label>          
  </div>

  <div class="form-floating mb-3">
    <input type="text" class="form-control" id="api_secret_key" name="api_secret_key" placeholder="Secret Key" value="{{ (isset($api_connection) ? $api_connection->api_secret_key : '') }}" required />
    <label for="api_secret_key">Secret Key</label>          
  </div>
