...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="client_name_subject" name="client_name_subject" placeholder="" aria-describedby="clientNameSubjectHelp" required readonly>
              <label for="client_name_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="off_address_subject" name="off_address_subject" placeholder="" aria-describedby="offAddressSubjectHelp" required readonly>
              <label for="off_address_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="off_postcode_subject" name="off_postcode_subject" placeholder="" aria-describedby="offPostcodeSubjectHelp" required readonly>
              <label for="off_postcode_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="off_city_subject" name="off_city_subject" placeholder="" aria-describedby="offCitySubjectHelp" required readonly>
              <label for="off_city_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="off_country_subject" name="off_country_subject" placeholder="" aria-describedby="offCountrySubjectHelp" required readonly>
              <label for="off_country_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="lrep_email_subject" name="lrep_email_subject" placeholder="" aria-describedby="lrepEmailSubjectHelp" required readonly>
              <label for="lrep_email_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="telephone_subject" name="telephone_subject" placeholder="" aria-describedby="telephoneSubjectHelp" required readonly>
              <label for="telephone_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="short_desc_subject" name="short_desc_subject" placeholder="" aria-describedby="shortDescSubjectHelp" required readonly>
              <label for="short_desc_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="employees_subject" name="employees_subject" placeholder="" aria-describedby="employeesSubjectHelp" required readonly>
              <label for="employees_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="start_date_subject" name="start_date_subject" placeholder="" aria-describedby="startDateSubjectHelp" required readonly>
              <label for="start_date_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="end_date_subject" name="end_date_subject" placeholder="" aria-describedby="endDateSubjectHelp" required readonly>
              <label for="end_date_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="lrep_fname_subject" name="lrep_fname_subject" placeholder="" aria-describedby="lrepFnameSubjectHelp" required readonly>
              <label for="lrep_fname_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="lrep_sname_subject" name="lrep_sname_subject" placeholder="" aria-describedby="lrepSnameSubjectHelp" required readonly>
              <label for="lrep_sname_subject">Subject</label>           
            </div> 
--}}            
          </div>        
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="lrep_address_subject" name="lrep_address_subject" placeholder="" aria-describedby="lrepAddressSubjectHelp" required readonly>
              <label for="lrep_address_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="lrep_postcode_subject" name="lrep_postcode_subject" placeholder="" aria-describedby="lrepPostcodeSubjectHelp" required readonly>
              <label for="lrep_postcode_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="lrep_city_subject" name="lrep_city_subject" placeholder="" aria-describedby="lrepCitySubjectHelp" required readonly>
              <label for="lrep_city_subject">Subject</label>           
            </div>
--}}            
          </div> 
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="risk_assessment_subject" name="risk_assessment_subject" placeholder="" aria-describedby="riskAssessmentSubjectHelp" required readonly>
              <label for="risk_assessment_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="use_trademark_subject" name="use_trademark_subject" placeholder="" aria-describedby="useTrademarkSubjectHelp" required readonly>
              <label for="use_trademark_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="trading_name_subject" name="trading_name_subject" placeholder="" aria-describedby="tradingNameSubjectHelp" required readonly>
              <label for="trading_name_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="economics_id_subject" name="economics_id_subject" placeholder="" aria-describedby="economicsIdSubjectHelp" required readonly>
              <label for="economics_id_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="adm_fee_subject" name="adm_fee_subject" placeholder="" aria-describedby="admFeeSubjectHelp" required readonly>
              <label for="adm_fee_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="consultancy_low_subject" name="consultancy_low_subject" placeholder="" aria-describedby="consultancyLowSubjectHelp" required readonly>
              <label for="consultancy_low_subject">Subject</label>           
            </div>
--}}            
          </div>
...
{{--
            <div class="form-floating">
              <input type="text" aria-label="Subject" class="form-control subject" id="consultancy_high_subject" name="consultancy_high_subject" placeholder="" aria-describedby="consultancyHighSubjectHelp" required readonly>
              <label for="consultancy_high_subject">Subject</label>           
            </div>
--}}            
          </div>
    ...
    <div class="col-md-6 d-flex">
      <div class="card mb-4" style="flex: 1;">
        ...
        <div class="card-body card-company-file-upload"> 
          ...
          <!-- Multi  --> 
          <form method="post" action="{{ url('company/files/0') }}" enctype="multipart/form-data" class="dropzone needsclick" id="dropzone-multi-company-0" data-clientid="0">
