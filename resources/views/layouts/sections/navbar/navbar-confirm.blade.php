  ...
  <div class="{{$containerNav}}">
    ...
    <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
      <a href="{{url('/')}}" class="app-brand-link gap-2">
        ...
        <span class="app-brand-text demo menu-text fw-bold">@include('_partials.macroshorizontal')</span>
      </a>
                    ...
                    <span class="fw-semibold d-block">                      
                      @if (Auth::check())
                        ...
                        @if (isset($authUser))
                          ...
                          @endphp
                        @else
                          {{ $approved_by_firstname . ' ' . $approved_by_lastname }}                    
                        @endif
                      @else
                      John Doe
                      @endif
                    </span>
                    <small class="text-muted">{{ str_replace('-', ' ', ucfirst($rolename)) }}</small>
                    <input type="hidden" name="auth_role" id="auth_role" value="{{ Auth::user()->roles()->first()->name }}">   
                  </div>
                </div>
              </a>
            </li>
    ...
    <div class="navbar-search-wrapper search-input-wrapper {{ isset($menuHorizontal) ? $containerNav : '' }} d-none">
      <input type="text" class="form-control search-input {{ isset($menuHorizontal) ? '' : $containerNav }} border-0" placeholder="Search..." aria-label="Search..." name="search">
