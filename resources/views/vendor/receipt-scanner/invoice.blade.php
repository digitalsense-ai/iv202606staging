...
- Line items (text, discountpercentage, qty, price, sku): Note, the 'qty' is typically 1 or minimal and the 'price' should be a number, excluding the currency element and should use a period as a decimal separator. The price data point must not be null, use "lineItems" as the key
