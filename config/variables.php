<?php
  ...
  return [
    "creatorName" => "OXYGEN",
    "creatorUrl" => "https://oxygenforsolutions.com",
    "templateName" => "IntraVAT",
    "templateSuffix" => "Admin",
    ...
    "livePreview" => "https://pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/landing-page/",
