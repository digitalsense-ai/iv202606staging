...
return [
  ...
  //     'themes',
  //   ], // To show/hide customizer options
  //   'menuShow' => true, // options[Boolean]: true(default), false // Layout(menu) Show
  //   'footerShow' => true, // options[Boolean]: true(default), false // Layout(menu) Show
  // ],
  // 'common' => [
  //   'pivsdate' => 10, //change it to 10 after testing
  //   'casdate' => 1,
  //   'ddadate' => 1,
  //   'statsdate' => 15
  // ]
